    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/persentase-kondisi-kelas-baik-sma-ma/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/persentase-kondisi-kelas-baik-sma-ma/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/persentase-kondisi-kelas-baik-sma-ma/create'
                  }
                },
                window.location.href = '#/admin/persentase-kondisi-kelas-baik-sma-ma/create')
        ...
        back() {
            window.location = '#/admin/persentase-kondisi-kelas-baik-sma-ma';
        }
    },
    mounted: function() {
        axios.get("/persentase-kondisi-kelas-baik-sma-ma/create").then(response => {
